...
\itemt{mstc(134) :}(D=0) 
 \begin{subentry}
    \itemt{$=0$ :} initial orientation of the impact parameter is only $x$-axis.
    \itemt{$=1$ :} impact parameter is randomly distributed both in $x$ and $y$-axis.
 \end{subentry}
...
\itemt{parc(24) :} (D=0.93957 GeV) neutron masses.
\itemt{parc(25) :} (D=0.93827 GeV) proton mass.
...
\itemt{pard(57) :} $\phi$ angle in the impact parameter:
$(b_x,b_y)=(b\cos\phi,b\sin\phi)$
to specify reaction plane see \ttt{mstc(134)}
