...
\itemt{mstc(6) :} (D=0) treatment of AA collisions.
   \begin{subentry}
      ...
      \itemt{$=101$ :} 101=RQMD/S with p-dep. int. mstc(3)\&parc(2) must be set
   \end{subentry}
...
\itemt{mstc(103) :}(D=1) option for RQMD/S transport.
 \begin{subentry}
            \itemt{$=0$ :} Calculate the displacement of r and p
			coming from potential potential derivative
			for the time of parc(2)
			at a time of potential evaluation.
            \itemt{$=1$ :} Displacement of r and p
            ...
            \itemt{$=2$ :} Same as {\tt mstc(103)}=1 with the time step of {\tt parc(16)},
			but collision list is kept for particles which does not feel MF.
...
\itemt{mstc(104) :}(D=1) option for RQMD/S transport.
 \begin{subentry}
            ...
            \itemt{$=10$ :} Potential effects are counted for nucleons (even before formation).
            \itemt{$=11$ :} Potential effects are counted for baryons (even before formation).
 \end{subentry}
\itemt{mstc(105) :}(D=1) Update frequency of collision list for {\tt mstc(103)}=2.

\itemt{mstc(198) :}(D=0) MF type in RQMD/S.
 \begin{subentry}
    \itemt{$=1$ :} Momentum Dependent Hard MF
    \itemt{$=2$ :} Momentum Dependent Medium MF
    \itemt{$=3$ :} Momentum Dependent Soft MF
    \itemt{$=4$ :} Momentum Independent Hard MF
    \itemt{$=5$ :} Momentum Independent Soft MF
 \end{subentry}

\itemt{mstc(199) :}(D=0) Momentum Cut-Off Scheme in RQMD/S.
 \begin{subentry}
...
\itemt{parc(17)-parc(20) :} not used.
%----------------------
% Constant parameters
%----------------------
