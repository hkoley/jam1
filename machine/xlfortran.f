...
c***********************************************************************
c                                                                      *
c   PART 6: Machine dependent routines for XL Fortran/IBM AIX          +
c                                                                      *
...
c     external dtime
      ...
      data timestr/'today  '/
      save  stime,cptime1
      integer(8) nstime,mstime

      if(ic.eq.0) then
        call dtime_(tarray,tresult)
        cptime1=tarray(1)
...
C.......2011/10/14, KM, for XL Fortran in IBM AIX
        nstime=irtc()
...
C.......2011/10/14, KM, for XL Fortran in IBM AIX
        nstime=irtc()-nstime  ! elapsed time in nanoseconds
        mstime=nstime/1000000 ! elapsed time in milliseconds
        stime=mstime/1000     ! elapsed time in seconds
