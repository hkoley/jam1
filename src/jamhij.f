...
c f ftotjet  to give the function for cal. of average jet x section    *
...
c s jamparton to calculate the structure function with nuclear effect  *
c f gmre     to calculate log. of Gamma function                       *
c                                                                      *
c                    Soft part                                         *
c                                                                      *
c f fnkick   to define function for pt**2 kick for soft interaction    *
c f fnkick2  to define the exponential pt distribution of sea quarks   *
...
c            General utilities                                         *
c                                                                      *
c s vegas0   to perform N-dimensional Monte Carlo integ'n              *
...
c...Jet cross section with nuclear shadowing effect.
...
c***********************************************************************
      ...
      subroutine jamparton(f,x1,x2,qq)
...
c***********************************************************************
c
c                  Functions for soft processes
c
c***********************************************************************

      function fnkick(x)

c...Purpose: to define function for pt**2 kick from soft interaction.
      implicit double precision(a-h, o-z)
      include 'jam2.inc'
...
c...Purpose: to define function for pt**2 kick for resonance production.
      implicit double precision(a-h, o-z)
      include 'jam2.inc'
...
c...Define the exponential pt distribution of sea quarks.
      implicit double precision(a-h, o-z)
      common/hiparnt/hipr1(100),ihpr2(50),hint1(100),ihnt2(50)
      save  /hiparnt/
...
c...Purpose: to define function of x dist. of valence quarks for baryons.
      implicit double precision(a-h, o-z)
        common/hiparnt/hipr1(100),ihpr2(50),hint1(100),ihnt2(50)
        save  /hiparnt/
...
c...Purpose: to define function of x dist. of valence quarks for mesons.
      implicit double precision(a-h, o-z)
        common/hiparnt/hipr1(100),ihpr2(50),hint1(100),ihnt2(50)
        save  /hiparnt/
...
c...Setup Monte Carlo generation of a specific function.
      implicit double precision(a-h, o-z)
      include 'jam2.inc'
...
c for many run with different incident energies
...
c       write(code,'(i20)')itag(ip)
c       call jamerrm(30,0,'(hifun:) This number already used'//code)
c     endif
c     itag(ip)=1
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c...Setup Monte Carlo generation of a specific function.
      implicit double precision(a-h, o-z)
      include 'jam2.inc'
c     parameter(nbin=200)
      parameter(nbin=1000) !rqmd
...
c     parameter(nbin=200)
     ...
     $ ,gam(10,0:nbin),xmin,xmax
      ...
      if(nbinmax.lt.nbin) nbinmax=nbin
      pmin=rr(ip,nbinmin)
      pmax=rr(ip,nbinmax)
